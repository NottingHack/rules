...
Members are entitled to a **35l storage box**, which can be purchased through HMS. You must label your box with the label printed from HMS. Some items must not be stored in members boxes:
...
**All items stored at the space is done so at the owners risk.**
